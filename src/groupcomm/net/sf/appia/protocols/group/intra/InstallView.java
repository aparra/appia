...
public class InstallView extends GroupSendableEvent {

  public InstallView() {}

  public InstallView(Channel channel, int dir, Session source, Group group, ViewID view_id) throws AppiaEventException {
