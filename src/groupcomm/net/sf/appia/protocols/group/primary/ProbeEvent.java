...
public class ProbeEvent extends GroupSendableEvent {
    ...
    public ProbeEvent(Channel channel, int dir, Session source, Group group, ViewID viewId, Message omsg) throws AppiaEventException {
        super(channel, dir, source, group, viewId, omsg);
    }

    public ProbeEvent(Channel channel, int dir, Session source, Group group, ViewID viewId) throws AppiaEventException {
