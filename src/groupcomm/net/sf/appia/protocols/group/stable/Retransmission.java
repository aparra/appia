...
public class Retransmission extends GroupSendableEvent implements Send {

  public Retransmission() {
    super();
  }

  public Retransmission(Message omsg, Channel channel, int dir, Session source, Group group, ViewID view_id) throws AppiaEventException {
