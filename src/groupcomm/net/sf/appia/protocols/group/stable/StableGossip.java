...
public class StableGossip extends GroupSendableEvent {

  protected long[] stored=null;

  public StableGossip() {}

  public StableGossip(Channel channel, int dir, Session source, Group group, ViewID view_id) throws AppiaEventException {
