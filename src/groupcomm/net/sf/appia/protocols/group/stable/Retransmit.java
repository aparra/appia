...
public class Retransmit extends GroupSendableEvent implements Send {

  public Retransmit() {
    super();
  }

  public Retransmit(Channel channel, int dir, Session source, Group group, ViewID view_id) throws AppiaEventException {
